...
/* loaded from: target.jar:jdk/nashorn/internal/ir/Symbol.class */
public final class Symbol implements Comparable<Symbol>, Cloneable, Serializable {
    ...
    static {
        ...
        if (stacktrace != null) {
            ...
            StringTokenizer st = new StringTokenizer(stacktrace, DocLint.TAGS_SEPARATOR);
        ...
        if (trace != null) {
            ...
            StringTokenizer st2 = new StringTokenizer(trace, DocLint.TAGS_SEPARATOR);
    ...
    public void print(PrintWriter stream) {
        StringBuilder sb = new StringBuilder();
        sb.append(align(this.name, 20)).append(": ").append(", ").append(align(this.firstSlot == -1 ? FlatClientProperties.TABBED_PANE_TAB_ROTATION_NONE : "" + this.firstSlot, 10));
        switch (this.flags & 3) {
            case 1:
                sb.append(" global");
                break;
