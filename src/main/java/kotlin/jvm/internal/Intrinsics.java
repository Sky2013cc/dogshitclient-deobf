...
/* loaded from: target.jar:kotlin/jvm/internal/Intrinsics.class */
public class Intrinsics {
    ...
    public static void checkReturnedValueIsNotNull(Object value, String className, String methodName) {
        if (value == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Method specified as non-null returned null: " + className + Constants.NAME_SEPARATOR + methodName)));
        }
    }
    ...
    public static void checkFieldIsNotNull(Object value, String className, String fieldName) {
        if (value == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Field specified as non-null is null: " + className + Constants.NAME_SEPARATOR + fieldName)));
        }
    }
    ...
    private static String createParameterIsNullExceptionMessage(String paramName) {
        ...
        return "Parameter specified as non-null is null: method " + className + Constants.NAME_SEPARATOR + methodName + ", parameter " + paramName;
    }
    ...
    @SinceKotlin(version = "1.4")
    /* loaded from: target.jar:kotlin/jvm/internal/Intrinsics$Kotlin.class */
