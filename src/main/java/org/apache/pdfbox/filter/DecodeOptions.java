...
/* loaded from: target.jar:org/apache/pdfbox/filter/DecodeOptions.class */
public class DecodeOptions {
    ...
    public void setFilterSubsampled(boolean filterSubsampled) {
        this.filterSubsampled = filterSubsampled;
    }

    /* loaded from: target.jar:org/apache/pdfbox/filter/DecodeOptions$FinalDecodeOptions.class */
