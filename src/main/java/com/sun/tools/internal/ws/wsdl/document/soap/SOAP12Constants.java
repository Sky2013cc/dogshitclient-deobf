...
/* loaded from: target.jar:com/sun/tools/internal/ws/wsdl/document/soap/SOAP12Constants.class */
public interface SOAP12Constants {
    ...
    public static final QName QNAME_ADDRESS = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", "address");
    public static final QName QNAME_BINDING = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", "binding");
    public static final QName QNAME_BODY = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", "body");
    public static final QName QNAME_FAULT = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", Constants.TAG_FAULT);
    public static final QName QNAME_HEADER = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", "header");
    public static final QName QNAME_HEADERFAULT = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", "headerfault");
    public static final QName QNAME_OPERATION = new QName("http://schemas.xmlsoap.org/wsdl/soap12/", Constants.TAG_OPERATION);
    ...
    public static final QName QNAME_ATTR_ITEM_TYPE = new QName("http://schemas.xmlsoap.org/soap/encoding/", Constants.ATTR_ITEM_TYPE);
    public static final QName QNAME_ATTR_ARRAY_SIZE = new QName("http://schemas.xmlsoap.org/soap/encoding/", "arraySize");
    ...
    public static final QName QNAME_ELEMENT_LONG = new QName("http://schemas.xmlsoap.org/soap/encoding/", sun.rmi.rmic.iiop.Constants.IDL_INT);
    public static final QName QNAME_ELEMENT_UNSIGNED_LONG = new QName("http://schemas.xmlsoap.org/soap/encoding/", "unsignedLong");
    public static final QName QNAME_ELEMENT_SHORT = new QName("http://schemas.xmlsoap.org/soap/encoding/", sun.rmi.rmic.iiop.Constants.IDL_SHORT);
    ...
    public static final QName QNAME_ELEMENT_FLOAT = new QName("http://schemas.xmlsoap.org/soap/encoding/", sun.rmi.rmic.iiop.Constants.IDL_FLOAT);
    public static final QName QNAME_ELEMENT_DOUBLE = new QName("http://schemas.xmlsoap.org/soap/encoding/", sun.rmi.rmic.iiop.Constants.IDL_DOUBLE);
    public static final QName QNAME_ELEMENT_BOOLEAN = new QName("http://schemas.xmlsoap.org/soap/encoding/", sun.rmi.rmic.iiop.Constants.IDL_BOOLEAN);
    ...
    public static final QName QNAME_ELEMENT_IDREF = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_IDREF);
    public static final QName QNAME_ELEMENT_IDREFS = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_IDREFS);
    public static final QName QNAME_ELEMENT_ENTITY = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_ENTITY);
    public static final QName QNAME_ELEMENT_ENTITIES = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_ENTITIES);
    public static final QName QNAME_ELEMENT_NOTATION = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_NOTATION);
    public static final QName QNAME_ELEMENT_NMTOKEN = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_NMTOKEN);
    public static final QName QNAME_ELEMENT_NMTOKENS = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_NMTOKENS);
    ...
    public static final QName QNAME_TYPE_LONG = new QName("http://schemas.xmlsoap.org/soap/encoding/", sun.rmi.rmic.iiop.Constants.IDL_INT);
    public static final QName QNAME_TYPE_UNSIGNED_LONG = new QName("http://schemas.xmlsoap.org/soap/encoding/", "unsignedLong");
    public static final QName QNAME_TYPE_SHORT = new QName("http://schemas.xmlsoap.org/soap/encoding/", sun.rmi.rmic.iiop.Constants.IDL_SHORT);
    ...
    public static final QName QNAME_TYPE_FLOAT = new QName("http://schemas.xmlsoap.org/soap/encoding/", sun.rmi.rmic.iiop.Constants.IDL_FLOAT);
    public static final QName QNAME_TYPE_DOUBLE = new QName("http://schemas.xmlsoap.org/soap/encoding/", sun.rmi.rmic.iiop.Constants.IDL_DOUBLE);
    public static final QName QNAME_TYPE_BOOLEAN = new QName("http://schemas.xmlsoap.org/soap/encoding/", sun.rmi.rmic.iiop.Constants.IDL_BOOLEAN);
    ...
    public static final QName QNAME_TYPE_IDREF = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_IDREF);
    public static final QName QNAME_TYPE_IDREFS = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_IDREFS);
    public static final QName QNAME_TYPE_ENTITY = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_ENTITY);
    public static final QName QNAME_TYPE_ENTITIES = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_ENTITIES);
    public static final QName QNAME_TYPE_NOTATION = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_NOTATION);
    public static final QName QNAME_TYPE_NMTOKEN = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_NMTOKEN);
    public static final QName QNAME_TYPE_NMTOKENS = new QName("http://schemas.xmlsoap.org/soap/encoding/", DTDParser.TYPE_NMTOKENS);
    public static final QName QNAME_TYPE_LANGUAGE = new QName("http://schemas.xmlsoap.org/soap/encoding/", "LANGUAGE");
    public static final QName QNAME_ATTR_ID = new QName("", Constants.ATTR_ID);
    public static final QName QNAME_ATTR_HREF = new QName("", Constants.ATTR_REF);
}
