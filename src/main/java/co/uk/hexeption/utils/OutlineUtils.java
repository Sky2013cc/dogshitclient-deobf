...
/* loaded from: target.jar:co/uk/hexeption/utils/OutlineUtils.class */
public class OutlineUtils {
    ...
    public static void checkSetupFBO() {
        Framebuffer fbo = MinecraftInstance.mc.func_147110_a();
    ...
    private static void setupFBO(Framebuffer fbo) {
        ...
        EXTFramebufferObject.glRenderbufferStorageEXT(36161, 34041, MinecraftInstance.mc.field_71443_c, MinecraftInstance.mc.field_71440_d);
