...
/* loaded from: target.jar:org/apache/pdfbox/pdmodel/font/encoding/Encoding.class */
public abstract class Encoding implements COSObjectable {
    ...
    protected final Map<Integer, String> codeToName = new HashMap(LinkerCallSite.ARGLIMIT);
    protected final Map<String, Integer> inverted = new HashMap(LinkerCallSite.ARGLIMIT);
    ...
    public void add(int code, String name) {
        ...
        this.inverted.putIfAbsent(name, Integer.valueOf(code));
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void overwrite(int code, String name) {
        Integer oldCode;
