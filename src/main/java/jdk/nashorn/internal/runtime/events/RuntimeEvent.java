...
/* loaded from: target.jar:jdk/nashorn/internal/runtime/events/RuntimeEvent.class */
public class RuntimeEvent<T> {
    ...
    public String toString() {
        ...
        sb.append('[').append(this.level).append("] ").append(this.value == null ? "null" : getValueClass().getSimpleName()).append(" value=").append(this.value);
        return sb.toString();
    }
