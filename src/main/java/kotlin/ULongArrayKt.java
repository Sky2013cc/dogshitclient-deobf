...
/* loaded from: target.jar:kotlin/ULongArrayKt.class */
public final class ULongArrayKt {
    ...
    private static final long[] ULongArray(int size, Function1<? super Integer, ULong> init) {
        ...
        for (int i = 0; i < size; i++) {
            int i2 = i;
            jArr[i2] = init.invoke(Integer.valueOf(i2)).m1390unboximpl();
        }
        return ULongArray.m1406constructorimpl(jArr);
    }
    ...
    private static final long[] m1411ulongArrayOfQwZRm1k(long... elements) {
