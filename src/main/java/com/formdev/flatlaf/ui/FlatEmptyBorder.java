...
/* loaded from: target.jar:com/formdev/flatlaf/ui/FlatEmptyBorder.class */
public class FlatEmptyBorder extends BorderUIResource.EmptyBorderUIResource {
    ...
    public static Insets scaleInsets(Component c, Insets insets, int top, int left, int bottom, int right) {
