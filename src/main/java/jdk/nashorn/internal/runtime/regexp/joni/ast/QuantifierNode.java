...
/* loaded from: target.jar:jdk/nashorn/internal/runtime/regexp/joni/ast/QuantifierNode.class */
public final class QuantifierNode extends StateNode {
    ...
    private static final String[] PopularQStr = {"?", Marker.ANY_MARKER, Marker.ANY_NON_NULL_MARKER, "??", "*?", "+?"};
    private static final String[] ReduceQStr = {"", "", Marker.ANY_MARKER, "*?", "??", "+ and ??", "+? and ?"};
    public static final int REPEAT_INFINITE = -1;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: target.jar:jdk/nashorn/internal/runtime/regexp/joni/ast/QuantifierNode$ReduceType.class */
