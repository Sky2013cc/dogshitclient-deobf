...
/* loaded from: target.jar:com/formdev/flatlaf/icons/FlatOptionPaneErrorIcon.class */
public class FlatOptionPaneErrorIcon extends FlatOptionPaneAbstractIcon {
    ...
    protected Shape createInside() {
        ...
        r0.append(new RoundRectangle2D.Float(14.0f, 7.0f, 4.0f, 12.0f, 4.0f, 4.0f), false);
