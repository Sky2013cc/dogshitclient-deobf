...
/* loaded from: target.jar:kotlinx/coroutines/internal/MainDispatcherFactory.class */
public interface MainDispatcherFactory {
    ...
    /* loaded from: target.jar:kotlinx/coroutines/internal/MainDispatcherFactory$DefaultImpls.class */
