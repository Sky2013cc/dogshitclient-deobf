...
/* loaded from: target.jar:com/jagrosh/discordipc/entities/User.class */
public class User {
    ...
    public String getAvatarUrl() {
        ...
        return "https://cdn.discordapp.com/avatars/" + getId() + RuntimeConstants.SIG_PACKAGE + getAvatarId() + (getAvatarId().startsWith("a_") ? ".gif" : ".png");
    }
    ...
    /* loaded from: target.jar:com/jagrosh/discordipc/entities/User$DefaultAvatar.class */
