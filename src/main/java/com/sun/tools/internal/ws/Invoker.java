...
/* loaded from: target.jar:com/sun/tools/internal/ws/Invoker.class */
public final class Invoker {
    static final String[] maskedPackages = {"com.sun.istack.internal.tools.", "com.sun.tools.internal.jxc.", "com.sun.tools.internal.xjc.", "com.sun.tools.internal.ws.", "com.sun.codemodel.internal.", "com.sun.relaxng.", "com.sun.xml.internal.xsom.", "com.sun.xml.internal.bind.", "com.ctc.wstx.", "org.codehaus.stax2.", "com.sun.xml.internal.messaging.saaj.", "com.sun.xml.internal.ws.", "com.oracle.webservices.internal.api."};
    ...
    public static int invoke(String mainClass, String[] args) throws Throwable {
        if (!noSystemProxies) {
            try {
                ...
                try {
                    ...
                    if (Arrays.asList(args).contains("-Xendorsed")) {
                        ...
                        if (urls.size() > 0) {
                            ...
                            cl = new ParallelWorldClassLoader(new URLClassLoader((URL[]) urls.toArray(new URL[urls.size()]), new MaskingClassLoader(cl, mask)), "");
                        }
                    }
                    ...
                    boolean r = ((Boolean) runMethod.invoke(tool, args)).booleanValue();
                    int i = r ? 0 : 1;
                    Thread.currentThread().setContextClassLoader(oldcc);
                    return i;
    ...
    public static boolean checkIfLoading22API() {
        try {
            Service.class.getMethod(sun.rmi.rmic.iiop.Constants.IDL_CONSTRUCTOR, URL.class, QName.class, WebServiceFeature[].class);
            return true;
        } catch (LinkageError | NoSuchMethodException e) {
            return false;
        }
    ...
    public static ClassLoader createClassLoader(ClassLoader cl) throws ClassNotFoundException, IOException, ToolsJarNotFoundException {
        ...
        return new ParallelWorldClassLoader(new URLClassLoader(urls, new MaskingClassLoader(cl, mask)), "");
    }
    ...
    private static URL[] findIstack22APIs(ClassLoader cl) throws ClassNotFoundException, IOException, ToolsJarNotFoundException {
        ...
        if (Service.class.getClassLoader() == null) {
            ...
            URL res2 = cl.getResource("javax/xml/bind/JAXBPermission.class");
            if (res2 == null) {
                throw new ClassNotFoundException("There's no JAXB 2.2 API in the classpath");
            }
            urls.add(ParallelWorldClassLoader.toJarUrl(res2));
        }
        findToolsJar(cl, urls);
