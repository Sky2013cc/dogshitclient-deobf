...
/* loaded from: target.jar:com/sun/tools/internal/ws/wsdl/document/soap/SOAPHeaderFault.class */
public class SOAPHeaderFault extends ExtensionImpl {
    ...
    public void validateThis() {
        ...
        if (this._use == SOAPUse.ENCODED) {
            throw new ValidationException("validation.unsupportedUse.encoded", Integer.valueOf(getLocator().getLineNumber()), getLocator().getSystemId());
        }
    }
}
