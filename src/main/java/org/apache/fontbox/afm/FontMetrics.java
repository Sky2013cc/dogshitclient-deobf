...
/* loaded from: target.jar:org/apache/fontbox/afm/FontMetrics.class */
public class FontMetrics {
    ...
    public boolean getIsFixedV() {
        return this.isFixedV == null ? this.vVector != null : this.isFixedV.booleanValue();
    }

    public void setIsFixedV(boolean isFixedVValue) {
        this.isFixedV = Boolean.valueOf(isFixedVValue);
    }
