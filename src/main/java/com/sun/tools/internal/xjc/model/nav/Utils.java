...
/* loaded from: target.jar:com/sun/tools/internal/xjc/model/nav/Utils.class */
final class Utils {
    ...
    static {
        try {
            ...
            Method getInstance = (Method) AccessController.doPrivileged(new PrivilegedAction<Method>() { // from class: com.sun.tools.internal.xjc.model.nav.Utils.1
