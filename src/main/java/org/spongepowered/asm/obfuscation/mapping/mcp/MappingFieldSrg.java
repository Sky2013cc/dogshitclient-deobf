...
/* loaded from: target.jar:org/spongepowered/asm/obfuscation/mapping/mcp/MappingFieldSrg.class */
public class MappingFieldSrg extends MappingField {
    ...
    public MappingFieldSrg(MappingField field) {
        ...
        this.srg = field.getOwner() + RuntimeConstants.SIG_PACKAGE + field.getName();
    }
