...
/* loaded from: target.jar:com/sun/xml/internal/xsom/util/ContextClassloaderLocal.class */
public abstract class ContextClassloaderLocal<V> {
    ...
    private static ClassLoader getContextClassLoader() {
        return (ClassLoader) AccessController.doPrivileged(new PrivilegedAction() { // from class: com.sun.xml.internal.xsom.util.ContextClassloaderLocal.1
