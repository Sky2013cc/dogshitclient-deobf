...
/* loaded from: target.jar:org/spongepowered/asm/lib/util/CheckMethodAdapter.class */
public class CheckMethodAdapter extends MethodVisitor {
    ...
    public void visitTypeInsn(int opcode, String type) {
        ...
        checkInternalName(type, Constants.ATTR_TYPE);
    ...
    private void doVisitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
        ...
        if (opcode != 183 || !org.spongepowered.asm.util.Constants.CTOR.equals(name)) {
