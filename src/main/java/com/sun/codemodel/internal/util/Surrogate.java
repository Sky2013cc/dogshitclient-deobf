...
/* loaded from: target.jar:com/sun/codemodel/internal/util/Surrogate.class */
class Surrogate {
    ...
    public static char high(int uc) {
        return (char) (55296 | (((uc - 65536) >> 10) & Position.MAXCOLUMN));
    }

    public static char low(int uc) {
        return (char) (56320 | ((uc - 65536) & Position.MAXCOLUMN));
    }
    ...
    /* loaded from: target.jar:com/sun/codemodel/internal/util/Surrogate$Parser.class */
    ...
    /* loaded from: target.jar:com/sun/codemodel/internal/util/Surrogate$Generator.class */
