...
/* loaded from: target.jar:org/apache/pdfbox/pdmodel/documentinterchange/logicalstructure/Revisions.class */
public class Revisions<T> {
    ...
    public void setRevisionNumber(T object, int revisionNumber) {
