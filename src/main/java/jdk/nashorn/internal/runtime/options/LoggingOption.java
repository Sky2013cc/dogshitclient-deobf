...
/* loaded from: target.jar:jdk/nashorn/internal/runtime/options/LoggingOption.class */
public class LoggingOption extends KeyValueOption {
    private final Map<String, LoggerInfo> loggers;

    /* loaded from: target.jar:jdk/nashorn/internal/runtime/options/LoggingOption$LoggerInfo.class */
