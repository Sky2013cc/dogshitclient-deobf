...
/* loaded from: target.jar:com/sun/tools/corba/se/idl/constExpr/LessEqual.class */
    ...
    public Object evaluate() throws EvaluationException {
        try {
            ...
            if (evaluate instanceof Boolean) {
                throw new EvaluationException(Util.getMessage("EvaluationException.1", new String[]{Util.getMessage("EvaluationException.lessEqual"), left().value().getClass().getName(), right().value().getClass().getName()}));
            }
