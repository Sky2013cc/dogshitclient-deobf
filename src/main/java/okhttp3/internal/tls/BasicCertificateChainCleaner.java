...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public List<Certificate> clean(@NotNull List<? extends Certificate> chain, @NotNull String hostname) throws SSLPeerUnverifiedException {
        ...
        for (int c = 0; c < 9; c++) {
            ...
            if (trustedCert != null) {
                ...
                Intrinsics.checkNotNullExpressionValue(i, "iterator(...)");
                while (i.hasNext()) {
                    Object next = i.next();
    ...
    /* loaded from: target.jar:okhttp3/internal/tls/BasicCertificateChainCleaner$Companion.class */
