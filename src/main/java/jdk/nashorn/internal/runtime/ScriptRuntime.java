...
/* loaded from: target.jar:jdk/nashorn/internal/runtime/ScriptRuntime.class */
public final class ScriptRuntime {
    ...
    /* loaded from: target.jar:jdk/nashorn/internal/runtime/ScriptRuntime$RangeIterator.class */
    ...
    public static boolean LT(Object x, Object y) {
        Object px = JSType.toPrimitive(x, (Class<?>) Number.class);
        Object py = JSType.toPrimitive(y, (Class<?>) Number.class);
