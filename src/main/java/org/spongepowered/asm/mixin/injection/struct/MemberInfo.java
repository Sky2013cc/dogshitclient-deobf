...
/* loaded from: target.jar:org/spongepowered/asm/mixin/injection/struct/MemberInfo.class */
public final class MemberInfo {
    ...
    public MemberInfo(String name, String owner, String desc, boolean matchAll, String unparsed) {
        if (owner != null && owner.contains(Constants.NAME_SEPARATOR)) {
    ...
    public String toString() {
        String owner = this.owner != null ? "L" + this.owner + RuntimeConstants.SIG_ENDCLASS : "";
        String name = this.name != null ? this.name : "";
        String qualifier = this.matchAll ? Marker.ANY_MARKER : "";
        String desc = this.desc != null ? this.desc : "";
        String separator = desc.startsWith(RuntimeConstants.SIG_METHOD) ? "" : this.desc != null ? CallSiteDescriptor.TOKEN_DELIMITER : "";
    ...
    public String toSrg() {
        ...
        if (this.desc.startsWith(RuntimeConstants.SIG_METHOD)) {
            return this.owner + RuntimeConstants.SIG_PACKAGE + this.name + " " + this.desc;
        }
        return this.owner + RuntimeConstants.SIG_PACKAGE + this.name;
    }
    ...
    public String toCtorDesc() {
        if (this.desc != null && this.desc.startsWith(RuntimeConstants.SIG_METHOD) && this.desc.indexOf(41) > -1) {
            return this.desc.substring(0, this.desc.indexOf(41) + 1) + RuntimeConstants.SIG_VOID;
        }
        return null;
    }
    ...
    public String getReturnType() {
        ...
        if (returnType.startsWith("L") && returnType.endsWith(RuntimeConstants.SIG_ENDCLASS)) {
    ...
    public boolean isField() {
        return this.forceField || !(this.desc == null || this.desc.startsWith(RuntimeConstants.SIG_METHOD));
    }

    public boolean isConstructor() {
        return org.spongepowered.asm.util.Constants.CTOR.equals(this.name);
    }

    public boolean isClassInitialiser() {
        return org.spongepowered.asm.util.Constants.CLINIT.equals(this.name);
    }
