...
/* loaded from: target.jar:org/spongepowered/asm/mixin/injection/struct/InjectorGroupInfo.class */
public class InjectorGroupInfo {
    ...
    /* loaded from: target.jar:org/spongepowered/asm/mixin/injection/struct/InjectorGroupInfo$Map.class */
    public static final class Map extends HashMap<String, InjectorGroupInfo> {
        ...
        public InjectorGroupInfo parseGroup(MethodNode method, String defaultGroup) {
            return parseGroup(Annotations.getInvisible(method, (Class<? extends Annotation>) Group.class), defaultGroup);
        }
