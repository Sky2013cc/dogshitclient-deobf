...
/* loaded from: target.jar:org/apache/fontbox/type1/Token.class */
class Token {
    ...
    /* loaded from: target.jar:org/apache/fontbox/type1/Token$Kind.class */
    enum Kind {
        NONE,
        STRING,
        NAME,
    ...
    public boolean booleanValue() {
        return this.text.equals(Constants.TRUE);
    }
