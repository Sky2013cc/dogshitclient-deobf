...
/* loaded from: target.jar:org/spongepowered/asm/util/ObfuscationUtil.class */
public abstract class ObfuscationUtil {

    /* loaded from: target.jar:org/spongepowered/asm/util/ObfuscationUtil$IClassRemapper.class */
