...
/* loaded from: target.jar:org/spongepowered/tools/obfuscation/ObfuscationType.class */
public final class ObfuscationType {
    ...
    public List<String> getInputFileNames() {
        ...
        if (extraInputFiles != null) {
            for (String extraInputFile : extraInputFiles.split(RuntimeConstants.SIG_ENDCLASS)) {
