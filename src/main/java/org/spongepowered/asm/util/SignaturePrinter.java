...
/* loaded from: target.jar:org/spongepowered/asm/util/SignaturePrinter.class */
public class SignaturePrinter {
    ...
    private StringBuilder appendArgs(StringBuilder sb, boolean typesOnly, boolean pretty) {
        ...
        return sb.append(RuntimeConstants.SIG_ENDMETHOD);
    }
    ...
    public static String getTypeName(Type type, boolean box, boolean fullyQualified) {
        switch (type.getSort()) {
            case 0:
                return box ? "Void" : sun.rmi.rmic.iiop.Constants.IDL_VOID;
            case 1:
                return box ? "Boolean" : sun.rmi.rmic.iiop.Constants.IDL_BOOLEAN;
            case 2:
                return box ? "Character" : "char";
            case 3:
                return box ? "Byte" : "byte";
            case 4:
                return box ? "Short" : sun.rmi.rmic.iiop.Constants.IDL_SHORT;
            case 5:
                return box ? "Integer" : "int";
            case 6:
                return box ? "Float" : sun.rmi.rmic.iiop.Constants.IDL_FLOAT;
            case 7:
                return box ? "Long" : sun.rmi.rmic.iiop.Constants.IDL_INT;
            case 8:
                return box ? PDLayoutAttributeObject.BORDER_STYLE_DOUBLE : sun.rmi.rmic.iiop.Constants.IDL_DOUBLE;
            case 9:
            ...
            case 10:
                ...
                return typeName;
            default:
                return sun.rmi.rmic.iiop.Constants.IDL_CORBA_OBJECT;
        }
    }

    private static String arraySuffix(Type type) {
        return Strings.repeat(_UrlKt.PATH_SEGMENT_ENCODE_SET_URI, type.getDimensions());
    }
