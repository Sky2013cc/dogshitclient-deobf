...
/* loaded from: target.jar:org/scijava/nativelib/NativeLibraryUtil.class */
public class NativeLibraryUtil {
    ...
    /* loaded from: target.jar:org/scijava/nativelib/NativeLibraryUtil$Architecture.class */
    ...
    /* loaded from: target.jar:org/scijava/nativelib/NativeLibraryUtil$Processor.class */
    ...
    public static String getPlatformLibraryPath() {
        String path = "META-INF/lib/" + getArchitecture().name().toLowerCase() + "/";
    ...
    public static String getVersionedLibraryName(Class libraryJarClass, String libName) {
        ...
        if (null != version && version.length() > 0) {
            libName = libName + TagletManager.ALT_SIMPLE_TAGLET_OPT_SEPARATOR + version;
        }
        return libName;
    }
