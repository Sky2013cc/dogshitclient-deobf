...
/* loaded from: target.jar:org/spongepowered/asm/mixin/MixinEnvironment.class */
public final class MixinEnvironment implements ITokenProvider {
    ...
    /* loaded from: target.jar:org/spongepowered/asm/mixin/MixinEnvironment$Side.class */
    public enum Side {
    ...
    /* loaded from: target.jar:org/spongepowered/asm/mixin/MixinEnvironment$Phase.class */
    ...
    /* loaded from: target.jar:org/spongepowered/asm/mixin/MixinEnvironment$Option.class */
    public enum Option {
        DEBUG_ALL("debug"),
        ...
        DEBUG_STRICT(DEBUG_ALL, Inherit.INDEPENDENT, Constants.ATTRVALUE_STRICT),
        ...
        CHECK_IMPLEMENTS_STRICT(CHECK_IMPLEMENTS, Inherit.ALLOW_OVERRIDE, Constants.ATTRVALUE_STRICT),
        ...
        REFMAP_REMAP_ALLOW_PERMISSIVE(ENVIRONMENT, Inherit.INDEPENDENT, "allowPermissiveMatch", true, Constants.TRUE),
        ...
        /* loaded from: target.jar:org/spongepowered/asm/mixin/MixinEnvironment$Option$Inherit.class */
        public enum Inherit {
            INHERIT,
            ALLOW_OVERRIDE,
            INDEPENDENT,
        ...
        Option(Option parent, Inherit inheritance, String property, boolean isFlag, String defaultStringValue) {
            ...
            this.property = (parent != null ? parent.property : PREFIX) + sun.rmi.rmic.iiop.Constants.NAME_SEPARATOR + property;
    ...
    /* loaded from: target.jar:org/spongepowered/asm/mixin/MixinEnvironment$CompatibilityLevel.class */
    ...
    /* loaded from: target.jar:org/spongepowered/asm/mixin/MixinEnvironment$TokenProviderWrapper.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: target.jar:org/spongepowered/asm/mixin/MixinEnvironment$MixinLogWatcher.class */
    public static class MixinLogWatcher {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* loaded from: target.jar:org/spongepowered/asm/mixin/MixinEnvironment$MixinLogWatcher$MixinAppender.class */
