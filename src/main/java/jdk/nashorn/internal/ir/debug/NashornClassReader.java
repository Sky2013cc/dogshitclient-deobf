...
/* loaded from: target.jar:jdk/nashorn/internal/ir/debug/NashornClassReader.class */
public class NashornClassReader extends ClassReader {
    ...
    static {
        ...
        type = new String[]{"<error>", "UTF8", "<error>", "Integer", "Float", "Long", PDLayoutAttributeObject.BORDER_STYLE_DOUBLE, "Class", "String", "Fieldref", "Methodref", "InterfaceMethodRef", "NameAndType", "<error>", "<error>", "MethodHandle", "MethodType", "<error>", "Invokedynamic"};
    }
    ...
    /* loaded from: target.jar:jdk/nashorn/internal/ir/debug/NashornClassReader$Constant.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: target.jar:jdk/nashorn/internal/ir/debug/NashornClassReader$IndexInfo.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: target.jar:jdk/nashorn/internal/ir/debug/NashornClassReader$IndexInfo2.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: target.jar:jdk/nashorn/internal/ir/debug/NashornClassReader$DirectInfo.class */
