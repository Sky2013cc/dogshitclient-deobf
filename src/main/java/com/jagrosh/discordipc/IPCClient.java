...
/* loaded from: target.jar:com/jagrosh/discordipc/IPCClient.class */
public final class IPCClient implements Closeable {
    ...
    /* loaded from: target.jar:com/jagrosh/discordipc/IPCClient$Event.class */
    public enum Event {
        NULL(false),
        READY(false),
        ERROR(false),
                            ...
                            try {
                                ...
                                switch (Event.of(json.getString("evt"))) {
                                    ...
                                    case ACTIVITY_JOIN_REQUEST:
                                        ...
                                        User user = new User(u.getString("username"), u.getString("discriminator"), Long.parseLong(u.getString(Constants.ATTR_ID)), u.optString("avatar", null));
