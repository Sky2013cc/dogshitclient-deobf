...
/* loaded from: target.jar:com/sun/xml/internal/rngom/binary/Pattern.class */
public abstract class Pattern implements ParsedPattern {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int combineHashCode(int hc1, int hc2, int hc3) {
        return hc1 * hc2 * hc3;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int combineHashCode(int hc1, int hc2) {
        return hc1 * hc2;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean containsChoice(Pattern p) {
        return this == p;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean contentTypeGroupable(int ct1, int ct2) {
        if (ct1 == 0 || ct2 == 0) {
            return true;
        }
        if (ct1 == 3 || ct2 == 3) {
