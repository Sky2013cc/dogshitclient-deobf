...
/* loaded from: target.jar:jdk/internal/dynalink/beans/GuardedInvocationComponent.class */
class GuardedInvocationComponent {
    private final GuardedInvocation guardedInvocation;
    private final Validator validator;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: target.jar:jdk/internal/dynalink/beans/GuardedInvocationComponent$ValidationType.class */
    ...
    /* loaded from: target.jar:jdk/internal/dynalink/beans/GuardedInvocationComponent$Validator.class */
