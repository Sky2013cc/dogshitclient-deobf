...
/* loaded from: target.jar:okio/FileHandle.class */
public abstract class FileHandle implements Closeable {
    ...
    public final long readNoCloseCheck(long fileOffset, Buffer sink, long byteCount) {
        ...
        while (true) {
            ...
            int readByteCount = protectedRead(currentOffset, bArr, i, (int) Math.min(a$iv, b$iv));
            if (readByteCount == -1) {
    ...
    /* loaded from: target.jar:okio/FileHandle$FileHandleSink.class */
    ...
    /* loaded from: target.jar:okio/FileHandle$FileHandleSource.class */
