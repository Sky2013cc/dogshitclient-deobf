...
/* loaded from: target.jar:org/spongepowered/tools/obfuscation/mapping/IMappingConsumer.class */
public interface IMappingConsumer {
    ...
    /* loaded from: target.jar:org/spongepowered/tools/obfuscation/mapping/IMappingConsumer$MappingSet.class */
    public static class MappingSet<TMapping extends IMapping<TMapping>> extends LinkedHashSet<Pair<TMapping>> {
        private static final long serialVersionUID = 1;

        /* loaded from: target.jar:org/spongepowered/tools/obfuscation/mapping/IMappingConsumer$MappingSet$Pair.class */
