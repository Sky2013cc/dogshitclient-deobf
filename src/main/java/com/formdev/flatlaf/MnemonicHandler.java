...
/* loaded from: target.jar:com/formdev/flatlaf/MnemonicHandler.class */
        ...
        if (e.getID() == 402) {
            ...
            if (selectMenuOnAltReleased && !e.isConsumed()) {
                ...
                if (menuSelectionManager2.getSelectedPath().length == 0) {
                    ...
                    if (menuBar == null) {
                        JFrame windowAncestor = SwingUtilities.getWindowAncestor(c);
                        if (windowAncestor instanceof JFrame) {
                            menuBar = windowAncestor.getJMenuBar();
                        } else if (windowAncestor instanceof JDialog) {
                            menuBar = ((JDialog) windowAncestor).getJMenuBar();
                        }
                    }
