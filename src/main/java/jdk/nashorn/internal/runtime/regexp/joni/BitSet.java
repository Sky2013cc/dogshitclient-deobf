...
/* loaded from: target.jar:jdk/nashorn/internal/runtime/regexp/joni/BitSet.class */
public final class BitSet {
    ...
    public String toString() {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            buffer.append(at(i) ? "1" : PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_ZERO_DEGREES);
        }
