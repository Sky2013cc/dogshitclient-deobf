...
/* loaded from: target.jar:org/spongepowered/asm/mixin/transformer/debug/RuntimeDecompiler.class */
public class RuntimeDecompiler extends IFernflowerLogger implements IDecompiler, IResultSaver {
    ...
    private final Map<String, Object> options = ImmutableMap.builder().put("din", PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_ZERO_DEGREES).put("rbr", PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_ZERO_DEGREES).put("dgs", "1").put("asc", "1").put("den", "1").put("hdc", "1").put("ind", "    ").build();
    ...
    public void saveClassFile(String path, String qualifiedName, String entryName, String content, int[] mapping) {
        File file = new File(this.outputPath, qualifiedName + Constants.SOURCE_FILE_EXTENSION);
