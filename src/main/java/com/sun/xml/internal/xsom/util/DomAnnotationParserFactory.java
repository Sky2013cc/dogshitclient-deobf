...
/* loaded from: target.jar:com/sun/xml/internal/xsom/util/DomAnnotationParserFactory.class */
public class DomAnnotationParserFactory implements AnnotationParserFactory {
    private static final ContextClassloaderLocal<SAXTransformerFactory> stf = new ContextClassloaderLocal<SAXTransformerFactory>() { // from class: com.sun.xml.internal.xsom.util.DomAnnotationParserFactory.1
        /* JADX INFO: Access modifiers changed from: protected */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // com.sun.xml.internal.xsom.util.ContextClassloaderLocal
        public SAXTransformerFactory initialValue() throws Exception {
            return (SAXTransformerFactory) SAXTransformerFactory.newInstance();
        }
    };

    @Override // com.sun.xml.internal.xsom.parser.AnnotationParserFactory
    ...
    /* loaded from: target.jar:com/sun/xml/internal/xsom/util/DomAnnotationParserFactory$AnnotationParserImpl.class */
