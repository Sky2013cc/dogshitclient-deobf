...
/* loaded from: target.jar:org/scijava/nativelib/BaseJniExtractor.class */
public abstract class BaseJniExtractor implements JniExtractor {
    ...
    private void init(Class libraryJarClass) throws IOException {
        ...
        if (mxSysInfo != null) {
            this.nativeResourcePaths = new String[]{"META-INF/lib/" + mxSysInfo + RuntimeConstants.SIG_PACKAGE, "META-INF/lib/"};
        } else {
    ...
    File extractResource(File dir, URL resource, String outputName) throws IOException {
        ...
        LOGGER.log(Level.FINE, "Extracting '" + resource + "' to '" + outfile.getAbsolutePath() + OperatorName.SHOW_TEXT_LINE);
