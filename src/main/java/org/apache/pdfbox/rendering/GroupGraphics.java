...
/* loaded from: target.jar:org/apache/pdfbox/rendering/GroupGraphics.class */
class GroupGraphics extends Graphics2D {
    ...
    public GroupGraphics(BufferedImage groupImage, Graphics2D groupGraphics) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void removeBackdrop(BufferedImage backdrop, int offsetX, int offsetY) {
        int backdropRGB;
        float alpha0;
        int backdropRGB2;
        float alpha02;
