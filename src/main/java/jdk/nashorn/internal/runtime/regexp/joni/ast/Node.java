...
/* loaded from: target.jar:jdk/nashorn/internal/runtime/regexp/joni/ast/Node.class */
public abstract class Node implements NodeType {
    ...
    public final String toString() {
        ...
        s.append("<" + getAddressName() + " (" + (this.parent == null ? "NULL" : this.parent.getAddressName()) + ")>");
