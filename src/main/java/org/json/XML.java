...
/* loaded from: target.jar:org/json/XML.class */
public class XML {
    ...
    public static String escape(String string) {
        ...
        Iterator<Integer> it = codePointIterator(string).iterator();
        while (it.hasNext()) {
    ...
    public static void noSpace(String string) throws JSONException {
        ...
        for (int i = 0; i < length; i++) {
            if (Character.isWhitespace(string.charAt(i))) {
                throw new JSONException(OperatorName.SHOW_TEXT_LINE + string + "' contains a space character.");
            }
        }
    }
    ...
    private static boolean parse(XMLTokener x, JSONObject context, String name, boolean keepStrings) throws JSONException {
        ...
        if (token == BANG) {
            ...
            if (c == '-') {
                ...
                if (DTDParser.TYPE_CDATA.equals(x.nextToken()) && x.next() == '[') {
        ...
        while (true) {
            ...
            if (token4 instanceof String) {
                ...
                if (token4 == EQ) {
                    ...
                    jsonobject.accumulate(string2, keepStrings ? (String) token5 : stringToValue((String) token5));
                    token4 = null;
                } else {
                ...
                while (true) {
                    ...
                    } else if (token6 == LT && parse(x, jsonobject, tagName, keepStrings)) {
                        if (jsonobject.length() == 0) {
                            context.accumulate(tagName, "");
                            return false;
                        }
    ...
    public static String toString(Object object, String tagName) throws JSONException {
        ...
        return tagName == null ? OperatorName.SHOW_TEXT_LINE_AND_SPACE + string + OperatorName.SHOW_TEXT_LINE_AND_SPACE : string.length() == 0 ? "<" + tagName + "/>" : "<" + tagName + ">" + string + "</" + tagName + ">";
    }
}
