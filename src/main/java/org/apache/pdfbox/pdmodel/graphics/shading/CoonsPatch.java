...
/* loaded from: target.jar:org/apache/pdfbox/pdmodel/graphics/shading/CoonsPatch.class */
class CoonsPatch extends Patch {
    /* JADX INFO: Access modifiers changed from: protected */
    public CoonsPatch(Point2D[] points, float[][] color) {
        super(color);
    ...
    private Point2D[][] reshapeControlPoints(Point2D[] points) {
        Point2D[][] fourRows = {r2, new Point2D[]{points[3], points[4], points[5], points[6]}, new Point2D[]{points[0], points[1], points[2], points[3]}, new Point2D[]{points[9], points[8], points[7], points[6]}};
        Point2D[] point2DArr = {points[0], points[11], points[10], points[9]};
        return fourRows;
    }
