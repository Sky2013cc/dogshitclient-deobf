...
/* loaded from: target.jar:org/knowm/xchart/style/markers/Rectangle.class */
public class Rectangle extends Marker {
    ...
    public void paint(Graphics2D g, double xOffset, double yOffset, int markerSize) {
        ...
        g.fill(new Rectangle2D.Double(xOffset - (halfSize / 2.0d), yOffset - halfSize, halfSize, markerSize));
    }
}
