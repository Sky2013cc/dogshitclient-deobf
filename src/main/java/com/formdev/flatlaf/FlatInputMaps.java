...
/* loaded from: target.jar:com/formdev/flatlaf/FlatInputMaps.class */
public class FlatInputMaps {
    FlatInputMaps() {
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void initInputMaps(UIDefaults defaults) {
    ...
    private static void initBasicInputMaps(UIDefaults defaults) {
        ...
        modifyInputMap(defaults, "ComboBox.ancestorInputMap", "UP", mac("selectPrevious2", "selectPrevious"), "DOWN", mac("selectNext2", "selectNext"), "KP_UP", mac("selectPrevious2", "selectPrevious"), "KP_DOWN", mac("selectNext2", "selectNext"), mac("alt UP", null), "togglePopup", mac("alt DOWN", null), "togglePopup", mac("alt KP_UP", null), "togglePopup", mac("alt KP_DOWN", null), "togglePopup");
        if (!SystemInfo.isMacOS) {
    ...
    /* loaded from: target.jar:com/formdev/flatlaf/FlatInputMaps$LazyInputMapEx.class */
    public static class LazyInputMapEx implements UIDefaults.LazyValue {
        ...
        public Object createValue(UIDefaults table) {
            ...
            for (Object[] bindings : this.bindingsArray) {
                LookAndFeel.loadKeyBindings(inputMapUIResource, bindings);
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: target.jar:com/formdev/flatlaf/FlatInputMaps$LazyModifyInputMap.class */
    public static class LazyModifyInputMap implements UIDefaults.LazyValue {
        ...
        public Object createValue(UIDefaults table) {
            InputMap inputMap;
            if (this.baseInputMap instanceof UIDefaults.LazyValue) {
                inputMap = (InputMap) ((UIDefaults.LazyValue) this.baseInputMap).createValue(table);
            } else {
                inputMap = (InputMap) this.baseInputMap;
            }
            ...
            for (int i = 0; i < this.bindings.length; i += 2) {
                ...
                if (this.bindings[i + 1] != null) {
                    inputMap2.put(keyStroke, this.bindings[i + 1]);
                } else {
