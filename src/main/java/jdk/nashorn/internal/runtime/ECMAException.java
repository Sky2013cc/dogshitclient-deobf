...
/* loaded from: target.jar:jdk/nashorn/internal/runtime/ECMAException.class */
public final class ECMAException extends NashornException {
    public static final CompilerConstants.Call CREATE = CompilerConstants.staticCallNoLookup(ECMAException.class, Constants.IDL_CONSTRUCTOR, ECMAException.class, Object.class, String.class, Integer.TYPE, Integer.TYPE);
