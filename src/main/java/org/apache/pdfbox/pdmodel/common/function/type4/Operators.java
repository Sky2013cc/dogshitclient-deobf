...
/* loaded from: target.jar:org/apache/pdfbox/pdmodel/common/function/type4/Operators.class */
public class Operators {
    ...
    public Operators() {
        ...
        this.operators.put(Constants.FALSE, FALSE);
        ...
        this.operators.put(Constants.TRUE, TRUE);
