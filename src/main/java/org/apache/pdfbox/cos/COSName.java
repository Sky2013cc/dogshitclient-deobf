...
/* loaded from: target.jar:org/apache/pdfbox/cos/COSName.class */
public final class COSName extends COSBase implements Comparable<COSName> {
    ...
    private static final Map<String, COSName> commonNameMap = new HashMap(StackType.REPEAT_INC);
    ...
    public static final COSName POPUP = new COSName(PDAnnotationPopup.SUB_TYPE);
    ...
    public static final COSName RT = new COSName(StandardStructureTypes.RT);
    ...
    public static final COSName THREAD = new COSName(PDActionThread.SUB_TYPE);
    ...
    public static final COSName V = new COSName(RuntimeConstants.SIG_VOID);
    ...
    public static final COSName WP = new COSName(StandardStructureTypes.WP);
