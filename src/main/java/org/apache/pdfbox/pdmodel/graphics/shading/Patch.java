...
/* loaded from: target.jar:org/apache/pdfbox/pdmodel/graphics/shading/Patch.class */
abstract class Patch {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public double getLen(Point2D ps, Point2D pe) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public boolean isEdgeALine(Point2D[] ctl) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public double edgeEquationValue(Point2D p, Point2D p1, Point2D p2) {
    ...
    public List<ShadedTriangle> getShadedTriangles(CoordinateColorPair[][] patchCC) {
