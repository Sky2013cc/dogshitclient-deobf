...
/* loaded from: target.jar:jdk/nashorn/internal/runtime/ECMAErrors.class */
public final class ECMAErrors {
    ...
    public static boolean isScriptFrame(StackTraceElement frame) {
        ...
        return (!className.startsWith(scriptPackage) || CompilerConstants.isInternalMethodName(frame.getMethodName()) || (source = frame.getFileName()) == null || source.endsWith(Constants.SOURCE_FILE_EXTENSION)) ? false : true;
    }
}
