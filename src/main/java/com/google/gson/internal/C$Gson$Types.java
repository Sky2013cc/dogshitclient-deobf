...
/* loaded from: target.jar:com/google/gson/internal/$Gson$Types.class */
public final class C$Gson$Types {
    ...
    /* loaded from: target.jar:com/google/gson/internal/$Gson$Types$ParameterizedTypeImpl.class */
    ...
    /* loaded from: target.jar:com/google/gson/internal/$Gson$Types$GenericArrayTypeImpl.class */
    public static final class GenericArrayTypeImpl implements GenericArrayType, Serializable {
        ...
        public String toString() {
            return C$Gson$Types.typeToString(this.componentType) + _UrlKt.PATH_SEGMENT_ENCODE_SET_URI;
        }
    }
    ...
    /* loaded from: target.jar:com/google/gson/internal/$Gson$Types$WildcardTypeImpl.class */
