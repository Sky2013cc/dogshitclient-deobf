...
/* loaded from: target.jar:net/ccbluex/liquidbounce/utils/render/shader/shaders/GradientFontShader.class */
public final class GradientFontShader extends Shader implements Closeable {
    ...
    @NotNull
    public static final GradientFontShader INSTANCE = new GradientFontShader();
    private static float speed = 1.0f;
    private static int maxColors = 9;

    private GradientFontShader() {
        super("gradient_font_shader.frag");
    }
    ...
    static {
        GradientFontShader gradientFontShader = INSTANCE;
        int i = maxColors;
        ?? r0 = new float[i];
    ...
    public void setupUniforms() {
        ...
        L6f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.setupUniforms():void");
    }
    ...
    public void updateUniforms() {
        /*
            ...
            float r1 = net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.strengthX
            float r2 = net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.strengthY
            org.lwjgl.opengl.GL20.glUniform2f(r0, r1, r2)
            r0 = r7
            java.lang.String r1 = "offset"
            int r0 = r0.getUniform(r1)
            float r1 = net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.offset
            org.lwjgl.opengl.GL20.glUniform1f(r0, r1)
            r0 = r7
            java.lang.String r1 = "speed"
            int r0 = r0.getUniform(r1)
            float r1 = net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.speed
            org.lwjgl.opengl.GL20.glUniform1f(r0, r1)
            r0 = r7
            java.lang.String r1 = "maxColors"
            int r0 = r0.getUniform(r1)
            int r1 = net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.maxColors
            org.lwjgl.opengl.GL20.glUniform1i(r0, r1)
            r0 = 0
            r8 = r0
            int r0 = net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.maxColors
            r9 = r0
        L39:
            r0 = r8
            r1 = r9
        ...
        L3f:
            ...
            float[][] r1 = net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.colors     // Catch: java.lang.Exception -> L7d
            r2 = r8
            r1 = r1[r2]     // Catch: java.lang.Exception -> L7d
            r2 = 0
            r1 = r1[r2]     // Catch: java.lang.Exception -> L7d
            float[][] r2 = net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.colors     // Catch: java.lang.Exception -> L7d
            r3 = r8
            r2 = r2[r3]     // Catch: java.lang.Exception -> L7d
            r3 = 1
            r2 = r2[r3]     // Catch: java.lang.Exception -> L7d
            float[][] r3 = net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.colors     // Catch: java.lang.Exception -> L7d
            r4 = r8
            r3 = r3[r4]     // Catch: java.lang.Exception -> L7d
            r4 = 2
            r3 = r3[r4]     // Catch: java.lang.Exception -> L7d
            float[][] r4 = net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.colors     // Catch: java.lang.Exception -> L7d
            r5 = r8
        ...
        Lac:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: net.ccbluex.liquidbounce.utils.render.shader.shaders.GradientFontShader.updateUniforms():void");
    }
    ...
    @NotNull
    public final GradientFontShader begin(boolean enable, float x, float y, @NotNull List<float[]> gradient, float speed2, float offset2) {
