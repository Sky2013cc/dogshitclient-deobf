...
/* loaded from: target.jar:com/sun/codemodel/internal/writer/FileCodeWriter.class */
public class FileCodeWriter extends CodeWriter {
    private final File target;
    private final boolean readOnly;
    private final Set<File> readonlyFiles;
    ...
    public File getFile(JPackage pkg, String fileName) throws IOException {
        File dir;
        if (pkg.isUnnamed()) {
            dir = this.target;
        } else {
