...
/* loaded from: target.jar:com/google/gson/stream/JsonWriter.class */
public class JsonWriter implements Closeable, Flushable {
    ...
    public JsonWriter beginArray() throws IOException {
        writeDeferredName();
        return open(1, RuntimeConstants.SIG_ARRAY);
    }
    ...
    public JsonWriter value(boolean value) throws IOException {
        writeDeferredName();
        beforeValue();
        this.out.write(value ? Constants.TRUE : Constants.FALSE);
        return this;
    }
    ...
    public JsonWriter value(Boolean value) throws IOException {
        ...
        writeDeferredName();
        beforeValue();
        this.out.write(value.booleanValue() ? Constants.TRUE : Constants.FALSE);
        return this;
    }
    ...
    */
    private void string(String value) throws IOException {
        ...
        this.out.write(OperatorName.SHOW_TEXT_LINE_AND_SPACE);
        int last = 0;
