...
/* loaded from: target.jar:org/apache/pdfbox/pdmodel/encryption/SaslPrep.class */
class SaslPrep {
    private SaslPrep() {
    }
    ...
    private static String saslPrep(String str, boolean allowUnassigned) {
        ...
        while (i4 < normalized.length()) {
            ...
            if (prohibited(codepoint)) {
                throw new IllegalArgumentException("Prohibited character '" + Character.getName(codepoint) + "' at position " + i4);
            }
