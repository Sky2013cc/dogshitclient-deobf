...
/* loaded from: target.jar:jdk/internal/dynalink/linker/LinkerServices.class */
public interface LinkerServices {
    ...
    /* loaded from: target.jar:jdk/internal/dynalink/linker/LinkerServices$Implementation.class */
