...
/* loaded from: target.jar:com/sun/tools/classfile/Opcode.class */
public enum Opcode {
    NOP(0),
    ACONST_NULL(1),
    ICONST_M1(2),
    ...
    /* loaded from: target.jar:com/sun/tools/classfile/Opcode$Set.class */
    public enum Set {
        STANDARD,
        PICOJAVA
    }
    ...
    Opcode(int i) {
        this(Set.STANDARD, i, Instruction.Kind.NO_OPERANDS);
    }

    Opcode(int i, Instruction.Kind kind) {
        this(Set.STANDARD, i, kind);
    }

    Opcode(Set set, int i) {
        this(set, i, set == Set.STANDARD ? Instruction.Kind.NO_OPERANDS : Instruction.Kind.WIDE_NO_OPERANDS);
    }

    Opcode(Set set, int i, Instruction.Kind kind) {
        this.set = set;
        this.opcode = i;
        this.kind = kind;
    }
