...
public class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final String getNameWithoutExtension(@NotNull Path $this$nameWithoutExtension) {
        ...
        if (fileName != null) {
            ...
            if (obj != null) {
                String substringBeforeLast$default = StringsKt.substringBeforeLast$default(obj, sun.rmi.rmic.iiop.Constants.NAME_SEPARATOR, (String) null, 2, (Object) null);
    ...
    public static final String getInvariantSeparatorsPathString(@NotNull Path $this$invariantSeparatorsPathString) {
        ...
        if (Intrinsics.areEqual(separator, RuntimeConstants.SIG_PACKAGE)) {
        ...
        return StringsKt.replace$default(obj, separator, RuntimeConstants.SIG_PACKAGE, false, 4, (Object) null);
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        ...
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.reifiedOperationMarker(4, RuntimeConstants.SIG_VOID);
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path $this$readAttributes, LinkOption... options) throws IOException {
        ...
        BasicFileAttributes readAttributes = Files.readAttributes($this$readAttributes, (Class<BasicFileAttributes>) BasicFileAttributes.class, (LinkOption[]) Arrays.copyOf(options, options.length));
