...
public final class RainbowShader extends Shader implements Closeable {
    ...
    @JvmStatic
    @NotNull
    public static final RainbowShader begin(boolean enable, float x, float y, float offset2) {
        if (enable) {
            RainbowShader rainbowShader = INSTANCE;
            strengthX = x;
            RainbowShader rainbowShader2 = INSTANCE;
            strengthY = y;
            RainbowShader rainbowShader3 = INSTANCE;
            offset = offset2;
