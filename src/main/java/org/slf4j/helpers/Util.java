...
/* loaded from: target.jar:org/slf4j/helpers/Util.class */
public final class Util {
    ...
    public static boolean safeGetBooleanSystemProperty(String key) {
        ...
        return value.equalsIgnoreCase(Constants.TRUE);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: target.jar:org/slf4j/helpers/Util$ClassContextSecurityManager.class */
