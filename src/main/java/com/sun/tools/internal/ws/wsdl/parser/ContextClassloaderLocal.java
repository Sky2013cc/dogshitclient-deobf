...
/* loaded from: target.jar:com/sun/tools/internal/ws/wsdl/parser/ContextClassloaderLocal.class */
abstract class ContextClassloaderLocal<V> {
    ...
    private static ClassLoader getContextClassLoader() {
        return (ClassLoader) AccessController.doPrivileged(new PrivilegedAction() { // from class: com.sun.tools.internal.ws.wsdl.parser.ContextClassloaderLocal.1
