...
/* loaded from: target.jar:com/madgag/gif/fmsware/LZWEncoder.class */
class LZWEncoder {
    ...
    int cur_accum = 0;
    int cur_bits = 0;
    int[] masks = {0, 1, 3, 7, 15, 31, 63, 127, 255, 511, Position.MAXCOLUMN, NashornCallSiteDescriptor.FLAGS_MASK, Flags.StandardFlags, 8191, 16383, ShortCompanionObject.MAX_VALUE, 65535};
