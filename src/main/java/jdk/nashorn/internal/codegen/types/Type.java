...
/* loaded from: target.jar:jdk/nashorn/internal/codegen/types/Type.class */
public abstract class Type implements Comparable<Type>, BytecodeOps, Serializable {
    ...
    /* loaded from: target.jar:jdk/nashorn/internal/codegen/types/Type$Unknown.class */
    ...
    /* loaded from: target.jar:jdk/nashorn/internal/codegen/types/Type$ValueLessType.class */
