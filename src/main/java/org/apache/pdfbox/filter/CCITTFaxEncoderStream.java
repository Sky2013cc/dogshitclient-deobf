...
/* loaded from: target.jar:org/apache/pdfbox/filter/CCITTFaxEncoderStream.class */
final class CCITTFaxEncoderStream extends OutputStream {
    ...
    public CCITTFaxEncoderStream(OutputStream stream, int columns, int rows, int fillOrder) {
        this.stream = stream;
    ...
    /* loaded from: target.jar:org/apache/pdfbox/filter/CCITTFaxEncoderStream$Code.class */
