...
/* loaded from: target.jar:org/spongepowered/asm/util/ConstraintParser.class */
public final class ConstraintParser {

    /* loaded from: target.jar:org/spongepowered/asm/util/ConstraintParser$Constraint.class */
    ...
    public static Constraint parse(String expr) {
        ...
        String[] exprs = expr.replaceAll("\\s", "").toUpperCase().split(RuntimeConstants.SIG_ENDCLASS);
