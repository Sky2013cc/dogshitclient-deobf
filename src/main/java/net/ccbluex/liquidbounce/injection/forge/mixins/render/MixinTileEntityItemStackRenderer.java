...
/* loaded from: target.jar:net/ccbluex/liquidbounce/injection/forge/mixins/render/MixinTileEntityItemStackRenderer.class */
public class MixinTileEntityItemStackRenderer {
    ...
    public void func_179022_a(ItemStack itemStackIn) {
        ...
        if (itemStackIn.func_77973_b() == Items.field_151144_bL) {
