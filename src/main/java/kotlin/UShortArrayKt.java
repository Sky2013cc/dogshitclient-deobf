...
/* loaded from: target.jar:kotlin/UShortArrayKt.class */
public final class UShortArrayKt {
    ...
    private static final short[] UShortArray(int size, Function1<? super Integer, UShort> init) {
        ...
        for (int i = 0; i < size; i++) {
            int i2 = i;
            sArr[i2] = init.invoke(Integer.valueOf(i2)).m1497unboximpl();
        }
        return UShortArray.m1513constructorimpl(sArr);
    }
    ...
    private static final short[] m1518ushortArrayOfrL5Bavg(short... elements) {
