...
/* loaded from: target.jar:org/json/JSONObject.class */
public class JSONObject {
    private final Map<String, Object> map;
    public static final Object NULL = new Null();

    /* loaded from: target.jar:org/json/JSONObject$Null.class */
        ...
        while (true) {
            ...
            switch (c) {
                ...
                default:
                    ...
                    if (key != null) {
                        if (opt(key) != null) {
                            throw x.syntaxError("Duplicate key \"" + key + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
                        }
    ...
    public static String doubleToString(double d) {
        ...
        if (string.indexOf(46) > 0 && string.indexOf(101) < 0 && string.indexOf(69) < 0) {
            while (string.endsWith(PDLayoutAttributeObject.GLYPH_ORIENTATION_VERTICAL_ZERO_DEGREES)) {
                string = string.substring(0, string.length() - 1);
            }
            if (string.endsWith(Constants.NAME_SEPARATOR)) {
                string = string.substring(0, string.length() - 1);
            }
        }
        return string;
    ...
    public <E extends Enum<E>> E getEnum(Class<E> cls, String str) throws JSONException {
        ...
        if (e == null) {
            throw new JSONException("JSONObject[" + quote(str) + "] is not an enum of type " + quote(cls.getSimpleName()) + Constants.NAME_SEPARATOR);
        }
        return e;
    }
    ...
    public boolean getBoolean(String key) throws JSONException {
        ...
        if (!object.equals(Boolean.FALSE)) {
            if ((object instanceof String) && ((String) object).equalsIgnoreCase(com.sun.tools.internal.ws.wsdl.parser.Constants.FALSE)) {
                return false;
            }
            if (!object.equals(Boolean.TRUE)) {
                if ((object instanceof String) && ((String) object).equalsIgnoreCase(com.sun.tools.internal.ws.wsdl.parser.Constants.TRUE)) {
                    return true;
                }
    ...
    public JSONObject putOnce(String key, Object value) throws JSONException {
        if (key != null && value != null) {
            if (opt(key) != null) {
                throw new JSONException("Duplicate key \"" + key + OperatorName.SHOW_TEXT_LINE_AND_SPACE);
            }
            put(key, value);
        }
        return this;
    ...
    public static Object stringToValue(String string) {
        ...
        if (string.equalsIgnoreCase(com.sun.tools.internal.ws.wsdl.parser.Constants.TRUE)) {
            return Boolean.TRUE;
        }
        if (string.equalsIgnoreCase(com.sun.tools.internal.ws.wsdl.parser.Constants.FALSE)) {
