...
/* loaded from: target.jar:okhttp3/CipherSuite.class */
public final class CipherSuite {
    ...
    public final String m3588deprecated_javaName() {
        return this.javaName;
    }
    ...
    /* loaded from: target.jar:okhttp3/CipherSuite$Companion.class */
