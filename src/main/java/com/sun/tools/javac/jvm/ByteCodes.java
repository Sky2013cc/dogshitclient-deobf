...
/* loaded from: target.jar:com/sun/tools/javac/jvm/ByteCodes.class */
public interface ByteCodes {
    ...
    public static final String[] typecodeNames = {"int", Constants.IDL_INT, Constants.IDL_FLOAT, Constants.IDL_DOUBLE, "object", "byte", "char", Constants.IDL_SHORT, Constants.IDL_VOID, "oops"};
}
