...
/* loaded from: target.jar:org/apache/pdfbox/cos/COSInteger.class */
public final class COSInteger extends COSNumber {
    ...
    private static COSInteger getInvalid(boolean maxValue) {
        return maxValue ? new COSInteger(LongCompanionObject.MAX_VALUE, false) : new COSInteger(Long.MIN_VALUE, false);
    }
    ...
    public void writePDF(OutputStream output) throws IOException {
        output.write(String.valueOf(this.value).getBytes(StandardCharsets.ISO_8859_1));
    }
}
