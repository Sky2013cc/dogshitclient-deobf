...
/* loaded from: target.jar:org/apache/pdfbox/pdmodel/encryption/SecurityHandlerFactory.class */
public final class SecurityHandlerFactory {
    ...
    private SecurityHandler<ProtectionPolicy> newSecurityHandler(Class<? extends SecurityHandler> handlerClass, Class<?>[] argsClasses, Object[] args) {
        try {
