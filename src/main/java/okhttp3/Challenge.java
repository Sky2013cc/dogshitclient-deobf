...
/* loaded from: target.jar:okhttp3/Challenge.class */
public final class Challenge {
    ...
    */
    public Challenge(@NotNull String scheme, @NotNull String realm) {
        this(scheme, (Map<String, String>) r2);
        Intrinsics.checkNotNullParameter(scheme, "scheme");
    ...
    public final String m3584deprecated_scheme() {
        return this.scheme;
    }
    ...
    public final Map<String, String> m3585deprecated_authParams() {
        return this.authParams;
    }
    ...
    public final String m3586deprecated_realm() {
        return realm();
    }
    ...
    public final Charset m3587deprecated_charset() {
        return charset();
    }
