...
/* loaded from: target.jar:com/sun/tools/doclets/internal/toolkit/util/DocPaths.class */
public class DocPaths {
    ...
    public static final DocPath indexN(int i) {
        return DocPath.create("index-" + i + ".html");
    }

    public static final DocPath profileFrame(String str) {
        return DocPath.create(str + "-frame.html");
    }

    public static final DocPath profilePackageFrame(String str) {
        return DocPath.create(str + "-package-frame.html");
    }

    public static final DocPath profilePackageSummary(String str) {
        return DocPath.create(str + "-package-summary.html");
    }

    public static final DocPath profileSummary(String str) {
        return DocPath.create(str + "-summary.html");
    }
}
