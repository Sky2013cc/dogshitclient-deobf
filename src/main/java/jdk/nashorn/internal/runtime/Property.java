...
/* loaded from: target.jar:jdk/nashorn/internal/runtime/Property.class */
public abstract class Property implements Serializable {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder();
        Class<?> t = getLocalType();
        sb.append(indent(getKey(), 20)).append(" id=").append(Debug.id(this)).append(" (0x").append(indent(Integer.toHexString(this.flags), 4)).append(") ").append(getClass().getSimpleName()).append(" {").append(indent(type(t), 5)).append('}');
        if (this.slot != -1) {
