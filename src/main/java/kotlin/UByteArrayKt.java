...
/* loaded from: target.jar:kotlin/UByteArrayKt.class */
public final class UByteArrayKt {
    ...
    private static final byte[] UByteArray(int size, Function1<? super Integer, UByte> init) {
        ...
        for (int i = 0; i < size; i++) {
            int i2 = i;
            bArr[i2] = init.invoke(Integer.valueOf(i2)).m1230unboximpl();
        }
        return UByteArray.m1246constructorimpl(bArr);
    }
    ...
    private static final byte[] m1251ubyteArrayOfGBYM_sE(byte... elements) {
