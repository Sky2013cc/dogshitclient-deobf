...
/* loaded from: target.jar:org/apache/pdfbox/util/filetypedetector/ByteTrie.class */
class ByteTrie<T> {
    private final ByteTrieNode<T> root = new ByteTrieNode<>();
    private int maxDepth;

    /* loaded from: target.jar:org/apache/pdfbox/util/filetypedetector/ByteTrie$ByteTrieNode.class */
