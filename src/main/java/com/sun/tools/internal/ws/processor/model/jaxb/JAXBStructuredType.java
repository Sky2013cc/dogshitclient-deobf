...
/* loaded from: target.jar:com/sun/tools/internal/ws/processor/model/jaxb/JAXBStructuredType.class */
public class JAXBStructuredType extends JAXBType {
    ...
    @Override // com.sun.tools.internal.ws.processor.model.jaxb.JAXBType
    ...
    public void setParentType(JAXBStructuredType parent) {
        if (this._parentType != null && parent != null && !this._parentType.equals(parent)) {
            throw new ModelException("model.parent.type.already.set", getName().toString(), this._parentType.getName().toString(), parent.getName().toString());
        }
