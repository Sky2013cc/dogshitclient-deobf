...
/* loaded from: target.jar:com/formdev/flatlaf/FlatClientProperties.class */
public interface FlatClientProperties {
    ...
    public static final String FULL_WINDOW_CONTENT_BUTTONS_PLACEHOLDER = "FlatLaf.fullWindowContent.buttonsPlaceholder";
    ...
    public static final String FULL_WINDOW_CONTENT = "FlatLaf.fullWindowContent";
    public static final String FULL_WINDOW_CONTENT_BUTTONS_BOUNDS = "FlatLaf.fullWindowContent.buttonsBounds";
    ...
    public static final String TITLE_BAR_HEIGHT = "JRootPane.titleBarHeight";
    ...
    public static final String MACOS_WINDOW_BUTTONS_SPACING = "FlatLaf.macOS.windowButtonsSpacing";
    public static final String MACOS_WINDOW_BUTTONS_SPACING_MEDIUM = "medium";
    public static final String MACOS_WINDOW_BUTTONS_SPACING_LARGE = "large";
    ...
    static <T> T clientProperty(JComponent jComponent, String str, T t, Class<T> cls) {
        T t2 = (T) jComponent.getClientProperty(str);
