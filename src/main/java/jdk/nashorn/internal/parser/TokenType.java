...
/* loaded from: target.jar:jdk/nashorn/internal/parser/TokenType.class */
public enum TokenType {
    ...
    LPAREN(TokenKind.BRACKET, RuntimeConstants.SIG_METHOD, 16, true),
    RPAREN(TokenKind.BRACKET, RuntimeConstants.SIG_ENDMETHOD, 0, true),
    ...
    COMMARIGHT(TokenKind.BINARY, DocLint.TAGS_SEPARATOR, 1, true),
    SUB(TokenKind.BINARY, TagletManager.ALT_SIMPLE_TAGLET_OPT_SEPARATOR, 12, true),
    DECPREFIX(TokenKind.UNARY, "--", 15, true),
    ASSIGN_SUB(TokenKind.BINARY, "-=", 2, false),
    PERIOD(TokenKind.BRACKET, Constants.NAME_SEPARATOR, 17, true),
    DIV(TokenKind.BINARY, RuntimeConstants.SIG_PACKAGE, 13, true),
    ASSIGN_DIV(TokenKind.BINARY, "/=", 2, false),
    COLON(TokenKind.BINARY, CallSiteDescriptor.TOKEN_DELIMITER),
    SEMICOLON(TokenKind.BINARY, RuntimeConstants.SIG_ENDCLASS),
    ...
    LBRACKET(TokenKind.BRACKET, RuntimeConstants.SIG_ARRAY, 17, true),
    ...
    FALSE(TokenKind.LITERAL, com.sun.tools.internal.ws.wsdl.parser.Constants.FALSE),
    ...
    PUBLIC(TokenKind.FUTURESTRICT, com.sun.tools.internal.ws.wsdl.parser.Constants.ATTR_PUBLIC),
    ...
    TRUE(TokenKind.LITERAL, com.sun.tools.internal.ws.wsdl.parser.Constants.TRUE),
    TRY(TokenKind.KEYWORD, "try"),
    TYPEOF(TokenKind.UNARY, "typeof", 14, false),
    VAR(TokenKind.KEYWORD, "var"),
    VOID(TokenKind.UNARY, Constants.IDL_VOID, 14, false),
