...
/* loaded from: target.jar:org/apache/pdfbox/pdmodel/graphics/blend/BlendComposite.class */
public final class BlendComposite implements Composite {
    ...
    /* loaded from: target.jar:org/apache/pdfbox/pdmodel/graphics/blend/BlendComposite$BlendCompositeContext.class */
    class BlendCompositeContext implements CompositeContext {
        ...
        public void compose(Raster src, Raster dstIn, WritableRaster dstOut) {
            ...
            boolean blendModeIsSeparable = BlendComposite.this.blendMode.isSeparableBlendMode();
                ...
                for (int x = x0; x < x1; x++) {
                    ...
                    if (blendModeIsSeparable) {
                        ...
                        for (int k = 0; k < numDstColorComponents; k++) {
                            ...
                            float value = BlendComposite.this.blendMode.getBlendChannelFunction().blendChannel(srcValue, dstValue);
                        ...
                        BlendComposite.this.blendMode.getBlendFunction().blend(srcConverted, dstConverted, rgbResult);
