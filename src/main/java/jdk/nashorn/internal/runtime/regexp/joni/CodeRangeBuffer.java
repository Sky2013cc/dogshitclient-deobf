...
/* loaded from: target.jar:jdk/nashorn/internal/runtime/regexp/joni/CodeRangeBuffer.class */
public final class CodeRangeBuffer implements Cloneable {
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.p[0]; i++) {
            buf.append(RuntimeConstants.SIG_ARRAY).append(rangeNumToString(this.p[(i * 2) + 1])).append("..").append(rangeNumToString(this.p[(i * 2) + 2])).append("]");
            if (i > 0 && i % 6 == 0) {
                buf.append("\n          ");
            }
        }
    ...
    public CodeRangeBuffer m1124clone() {
