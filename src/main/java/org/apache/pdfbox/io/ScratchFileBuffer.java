...
/* loaded from: target.jar:org/apache/pdfbox/io/ScratchFileBuffer.class */
public class ScratchFileBuffer implements RandomAccess {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public ScratchFileBuffer(ScratchFile pageHandler) throws IOException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void close(boolean removeBuffer) {
        if (this.pageHandler != null) {
