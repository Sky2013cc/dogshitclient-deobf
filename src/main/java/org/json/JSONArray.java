...
/* loaded from: target.jar:org/json/JSONArray.class */
public class JSONArray implements Iterable<Object> {
    ...
    public boolean getBoolean(int index) throws JSONException {
        ...
        if (!object.equals(Boolean.FALSE)) {
            if ((object instanceof String) && ((String) object).equalsIgnoreCase(Constants.FALSE)) {
                return false;
            }
            if (!object.equals(Boolean.TRUE)) {
                if ((object instanceof String) && ((String) object).equalsIgnoreCase(Constants.TRUE)) {
                    return true;
                }
    ...
    public <E extends Enum<E>> E getEnum(Class<E> cls, int i) throws JSONException {
        E e = (E) optEnum(cls, i);
        if (e == null) {
            throw new JSONException("JSONArray[" + i + "] is not an enum of type " + JSONObject.quote(cls.getSimpleName()) + sun.rmi.rmic.iiop.Constants.NAME_SEPARATOR);
        }
        return e;
    }
