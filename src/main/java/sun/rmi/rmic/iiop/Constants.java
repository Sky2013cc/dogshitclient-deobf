...
/* loaded from: target.jar:sun/rmi/rmic/iiop/Constants.class */
public interface Constants extends sun.rmi.rmic.Constants {
    ...
    public static final Identifier idBoolean = Identifier.lookup(IDL_BOOLEAN);
    ...
    public static final Identifier idShort = Identifier.lookup(IDL_SHORT);
    public static final Identifier idInt = Identifier.lookup("int");
    public static final String IDL_INT = "long";
    public static final Identifier idLong = Identifier.lookup(IDL_INT);
    public static final String IDL_FLOAT = "float";
    public static final Identifier idFloat = Identifier.lookup(IDL_FLOAT);
    public static final String IDL_DOUBLE = "double";
    public static final Identifier idDouble = Identifier.lookup(IDL_DOUBLE);
    ...
    public static final String[] IDL_KEYWORDS = {com.sun.tools.internal.ws.wsdl.parser.Constants.ATTR_ABSTRACT, IDL_ANY, "attribute", IDL_BOOLEAN, "case", "char", "const", "context", "custom", "default", IDL_DOUBLE, "enum", "exception", "factory", "FALSE", com.sun.tools.internal.ws.wsdl.parser.Constants.ATTR_FIXED, IDL_FLOAT, "in", "inout", "interface", IDL_INT, "module", "native", IDL_CORBA_OBJECT, IDL_BYTE, "oneway", "out", "private", com.sun.tools.internal.ws.wsdl.parser.Constants.ATTR_PUBLIC, "raises", "readonly", "sequence", IDL_SHORT, "string", "struct", "supports", "switch", "TRUE", "truncatable", "typedef", "unsigned", com.sun.tools.internal.ws.wsdl.parser.Constants.ATTRVALUE_UNION, "ValueBase", "valuetype", IDL_VOID, IDL_CHAR, IDL_CONSTANT_STRING};
