...
public interface CancellableContinuation<T> extends Continuation<T> {
    ...
    /* loaded from: target.jar:kotlinx/coroutines/CancellableContinuation$DefaultImpls.class */
