...
/* loaded from: target.jar:okhttp3/internal/http2/Header.class */
public final class Header {
    ...
    @JvmField
    @NotNull
    public static final ByteString PSEUDO_PREFIX = ByteString.Companion.encodeUtf8(CallSiteDescriptor.TOKEN_DELIMITER);
    ...
    /* loaded from: target.jar:okhttp3/internal/http2/Header$Companion.class */
