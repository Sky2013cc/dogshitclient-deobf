...
/* loaded from: target.jar:org/scijava/nativelib/MxSysInfo.class */
public class MxSysInfo {
    ...
    public static String guessMxSysInfo() {
        ...
        return arch + TagletManager.ALT_SIMPLE_TAGLET_OPT_SEPARATOR + os + TagletManager.ALT_SIMPLE_TAGLET_OPT_SEPARATOR + extra;
    }
}
